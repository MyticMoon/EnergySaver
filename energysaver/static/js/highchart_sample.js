/*
Pie chart with gradient and legend
*/
// $(function () {
//     var chart;
...
Pie chart basic
*/
var draw_pie_chart = function(dom_id) {
    $('#' + dom_id).highcharts({
        chart: {
            plotBackgroundColor: null,
            plotBorderWidth: null,
        ...
        title: {
            text: 'Power consumption this month'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
var draw_time_series = function(dom_id) {
  var chart;
